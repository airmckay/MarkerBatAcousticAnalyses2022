...
# for after aggregation later 
bats_sitemap <- bats2. %>% select(Site, Habitat, Locality, Facility) %>% distinct()
...
## Aggregate to by nighthour, site, behavior
df <- bats1. 
...
summary(temp7) #49854 obs of 5 vars
head(temp7)

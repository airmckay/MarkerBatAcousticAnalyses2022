...
plot1 <- 
  ...
  geom_line() + facet_wrap(~Habitat) + ggtitle("Turbine 9, LRE feeding, binary model") +
...
plot2 <- 
  fit1df %>% ggplot(aes(x=jnight, y=fit)) +
  geom_line() + facet_wrap(~Habitat) + ggtitle("Turbine 9, LRE commuting, binary model") +
  geom_ribbon(aes(ymin = lower, ymax = upper), fill = 'grey', alpha = 0.5)
...
plot3 <-
  fit1df %>% ggplot(aes(x=jnight, y=fit)) +
  geom_line() + facet_wrap(~Habitat) + ggtitle("Turbine 9, SRE feeding, binary model") +
  geom_ribbon(aes(ymin = lower, ymax = upper), fill = 'grey', alpha = 0.5)
...
plot4 <- 
  fit1df %>% ggplot(aes(x=jnight, y=fit)) +
  geom_line() + facet_wrap(~Habitat) + ggtitle("Turbine 9, SRE commuting, binary model") +
  geom_ribbon(aes(ymin = lower, ymax = upper), fill = 'grey', alpha = 0.5)

...
bmp(file.path(output_today, "prediction of temp at dif wind speeds m2b bats_tot.png"), width = 9, height = 6, units = "in", res = 350)
...
bmp(file.path(output_today, "checking k dimensions m1_LREf bats_tot.png"), width = 9, height = 6, units = "in", res = 350)
...
bmp(file.path(output_today, "predictions m1_LREf bats_tot.png"), width = 9, height = 6, units = "in", res = 350)

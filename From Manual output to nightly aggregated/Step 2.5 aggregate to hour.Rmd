...
#write.csv(hours.expand1, "active.nighthours.Marker2020.csv")
...
sum(test$batpass) # would lose 17 bat passes if I kept it at 2 hours... 3 hours gives us more zeros but keeps all bat passes.
...
dat9 <- left_join(dat8, weather.hours, by = "nighthour") #%>% select(- ...1)

summary(dat9)

sum(nbats4$batpass) # 19438
...
dat10 <- drop_na(dat9) 
summary(dat10)
sum(dat10$batpass) # 19437
#write.csv(dat10, "hourlaggregated_totalbats_zeroinserted_weather.csv")
```

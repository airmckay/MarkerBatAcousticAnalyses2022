...
getwd()
# "C:/Users/April/OneDrive - Norwegian University of Life Sciences/Documents/1. PhD_Main/GitHub/Marker_Acoustic_Analyses"
library(knitr)
library(data.table)
library(tidyverse)
library(beepr)
...
bats1. <- read_csv("C:/Users/April/OneDrive - Norwegian University of Life Sciences/Documents/1. PhD_Main/GitHub/Marker_Acoustic_Analyses/From Manual output to nightly aggregated/Outputs/Outputs_tidied/MarkerManual_cleaned_manualid_guild_sitenames.csv", 
...
active.nights <- Marker_night_inventory_0704_2022_edit <- read_delim("From Manual output to nightly aggregated/Inputs/Marker_night_inventory_0704.2022_edit.csv", 
...
#write.csv(nbats3, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/Documents/1. PhD_Main/GitHub/Marker_Acoustic_Analyses/From Manual output to nightly aggregated/Outputs/nightlyaggregatedMarker2020_totalbats_zeroinserted.csv")

```

# Aggregate the hourly weather datasets to nightly 
```{r}
weathernight <- nightlyaggregate_wind_temp <- read_csv("Inputs/nightlyaggregate_wind_temp.csv", col_types = cols(...1 = col_skip()))

nbats4 <- left_join(nbats3, weathernight, by = "night")
...
#write.csv(bats5, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/Documents/1. PhD_Main/GitHub/Marker_Acoustic_Analyses/From Manual output to nightly aggregated/Outputs/nightlyaggregatedMarker2020_totalbats_zeroinserted_weather_binary.csv")
...
agg_tbl2 <- bats5 %>% group_by(jnight, Site) %>% 
...
# write.csv(df2C, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/Documents/1. PhD_Main/GitHub/Marker_Acoustic_Analyses/From Manual output to nightly aggregated/Outputs/totalbatpass_summarytable_withbinary_batpass_night_aggregated.csv")

# Add back the other site data 

df3C <- left_join(df2C, bat_sitemap)

#write.csv(df3C, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/Documents/1. PhD_Main/GitHub/Marker_Acoustic_Analyses/From Manual output to nightly aggregated/Outputs/totalbatpass_summarytable_withbinary_batpass_night_aggregated_site data.csv")
...
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Habitat_batpass_prop_jnight.tif", width = 9, height = 6, units = "in", res = 350)

p <- ggplot()
p <- p + xlab("jnight") + ylab("batpassTOTAL_prop")
...
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Habitat_batpass_prop_temp_max.tif", width = 9, height = 6, units = "in", res = 350)
...
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Habitat_batpass_prop_temp_mean.tif", width = 9, height = 6, units = "in", res = 350)
...
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Habitat_batpass_prop_wind_max.tif", width = 9, height = 6, units = "in", res = 350)
...
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Habitat_batpass_prop_wind_mean.tif", width = 9, height = 6, units = "in", res = 350)
...
#write.csv(bats_gb_nights_sum1, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Outputs/bat pass aggregated by night wout zeronights_behavior and guild.csv")
...
#write.csv(nbats3, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Outputs/nightlyaggregatedMarker2020_totalbats_zeroinserted_behavior and guild.csv")

```

# Aggregate the hourly weather datasets to nightly 
```{r}
weathernight <- nightlyaggregate_wind_temp # using the same as above 
...
#write.csv(bats5, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Outputs/nightlyaggregatedMarker2020_totalbats_zeroinserted_weather_binary_behavior and guild.csv")
...
#write.csv(df2C, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Outputs/totalbatpass_summarytable_withbinary_batpass_night_aggregated_behavior and guild_night instead of jnight.csv")
...
#write.csv(df3C, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Outputs/totalbatpass_summarytable_withbinary_batpass_night_aggregated_site_behavior_guild data_night instead of jnight.csv")
...
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Survey effort per site.tif", width = 9, height = 6, units = "in", res = 350)
...
#write.csv(df3C, "C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp/Outputs/totalbatpass_summarytable_withbinary_batpass_night_aggregated_site_behavior_guild data_night instead of jnight_trimmed MRE social and met tower.csv")
...
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp1/Habitat_batpass_prop_night.tif", width = 9, height = 6, units = "in", res = 350)
...
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp1/Habitat_batpass_prop_temp1_max.tif", width = 9, height = 6, units = "in", res = 350)
...
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp1/Habitat_batpass_prop_temp1_mean.tif", width = 9, height = 6, units = "in", res = 350)
...
#batpass_prop	versus	wind_max			
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp1/Habitat_batpass_prop_wind_max.tif", width = 9, height = 6, units = "in", res = 350)
...
#batpass_prop	versus	wind_mean			
# save plot to file 
bmp("C:/Users/April/OneDrive - Norwegian University of Life Sciences/2. Marker 2019-2020/Marker 2022/temp1/Habitat_batpass_prop_wind_mean.tif", width = 9, height = 6, units = "in", res = 350)
